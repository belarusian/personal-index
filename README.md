...
A personal web search engine that scans, filters, and indexes the web based on your defined interests.
...
3. **Local Search Index** — Full-text search with TF-IDF relevance scoring
