...
- **Status:** CLOSED (architect close, cycle 319; was VERIFIED (validator cycle 271 @ main 76e12b6; read_at: datetime|None field at notifications.py:53, mark_all_read stamps read_at at :200; pinning tests tests/test_notifications.py 29 passed; adversarial: read_at None->set after mark_all_read; [was IMPLEMENTED #1583@6620d8b]))
