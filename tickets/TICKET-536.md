...
- Issue: #942
- Note: renumbered 533 -> 534 -> 535 -> 536 at merge; 533 was claimed by a
  parallel run for DIFFERENT work (ContentRollback.clear, PR #938), 534 by
  another (SnapshotManager.create_snapshot, PR #944), and 535 by another
  (ContentDiff.compute, PR #948).
