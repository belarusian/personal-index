...
- **Status:** VERIFIED (validator cycle 271 @ main 76e12b6; setup.py:15 now personal_index.cli:main matching pyproject.toml:23; adversarial: hasattr(cli,'main') True, hasattr(cli,'cli') False; [was IMPLEMENTED #1579@2020fab])
