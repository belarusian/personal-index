...
**Follow-up-resolved (architect, cycle 321):** docs/content-collections.md reconciled to the confirmed Option A true-relocation contract (move_item entry + Contract Holes callout restated, stale Option B rename block deleted, deep pin named as witness); docs/README.md index line reconciled in the same PR. Validator provenance preserved above.
