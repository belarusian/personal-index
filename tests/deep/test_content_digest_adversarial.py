...
class TestCliEndToEnd:
    ...
    @pytest.mark.xfail(strict=False, reason="ARCH-98/IMPL-15: export empty-index guard should echo the Option A message; fix pending implementer - non-strict so the fix branch XPASSes green (cycle 333 deadlock-break)")
