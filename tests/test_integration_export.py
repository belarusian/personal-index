...
class TestExportIntegration:
    ...
    def test_export_csv(self):
        ...
        from personal_index.content_export_csv import export_as_csv

        items = [
            {"title": "Test", "url": "https://example.com/1", "score": 0.9},
        ]
        csv_data = export_as_csv(items)
    ...
    def test_export_json(self):
        ...
        import json
        from personal_index.export import export_as_json

        items = [
            {"title": "Test", "url": "https://example.com/1", "score": 0.9},
        ]
        json_data = export_as_json(items)
